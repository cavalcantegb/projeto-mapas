...
class Agent(models.Model):
    ...
    state = models.CharField(max_length=2, default="", blank=True, null=True)
    neighbourhood = models.CharField(max_length=80, default="", blank=True, null=True)
    public_place = models.CharField(max_length=80, default="", blank=True, null=True)
    address_number = models.CharField(max_length=20, default="", blank=True, null=True)
    address_other_info = models.CharField(max_length=20, default="", blank=True, null=True)
    fields_of_art = models.CharField(max_length=400, default="", blank=True, null=True)
    tags = models.CharField(max_length=1000, default="", blank=True, null=True)
    verified_account = models.BooleanField(default=False)
    ...
    ethnic_type = models.CharField(max_length=20, default="", blank=True, null=True)
    sexual_orientation = models.CharField(max_length=40, default="", blank=True, null=True)
    civil_status = models.CharField(max_length=20, default="", blank=True, null=True)
    studies = models.CharField(max_length=20, default="", blank=True, null=True)
    ...
    natural_from = models.CharField(max_length=20, default="", blank=True, null=True)
    ...
    twitter = models.CharField(max_length=60, default="", blank=True, null=True)
    google_plus = models.CharField(max_length=60, default="", blank=True, null=True)
    instagram = models.CharField(max_length=60, default="", blank=True, null=True)
